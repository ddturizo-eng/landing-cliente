    ...
    <section id="nosotros" className="section py-8 sm:py-12 md:py-20 px-4 sm:px-6 md:px-8 bg-black">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-4 sm:gap-6 md:gap-12 items-center">
          ...
          <div className="relative h-48 sm:h-64 md:h-80 lg:h-[500px] rounded-lg sm:rounded-xl md:rounded-2xl overflow-hidden shadow-2xl border border-purple-600/20 hover:border-purple-600/50 transition-all duration-300 group">
            <Image 
              src="/img/logo-hc-efectos-white.jpg" 
